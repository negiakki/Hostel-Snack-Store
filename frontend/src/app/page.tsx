...
import { CustomerStoreStatusBanner } from "@/components/store-status/customer-store-status-banner";
...
export default async function Home() {
  ...
  return (
    <main className="flex flex-1 flex-col bg-white px-4 py-4 text-black sm:px-6 sm:py-6">
      <div className="mx-auto w-full max-w-5xl">
        <CustomerStoreStatusBanner />
      </div>
      <div className="flex flex-1 items-center justify-center py-12">
        <section aria-labelledby="setup-title" className="w-full max-w-xl">
          ...
          <p className="mt-6 text-base leading-6 text-zinc-600">
            The frontend foundation is ready to communicate with the backend
            API.
          </p>
